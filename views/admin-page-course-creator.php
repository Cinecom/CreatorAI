<?php
/**
 * View for the Course Creator Admin Page
 *
 * @package CreatorAI
 */

// Check for OpenAI API key.
$has_api_key = ! empty( get_option( 'cai_openai_api_key' ) );
?>
<div class="wrap course-creator-wrap">
    <h1>
        ...
        <?php esc_html_e( 'AI Course Creator', 'creator-ai' ); ?>
    </h1>

    <?php if ( ! $has_api_key ) : ?>
        <div class="notice notice-error">
            <p><?php esc_html_e( 'OpenAI API key is required for the Course Creator. Please configure it in the settings.', 'creator-ai' ); ?></p>
            <p><a href="<?php echo esc_url( admin_url( 'admin.php?page=creator-ai-settings' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to Settings', 'creator-ai' ); ?></a></p>
        </div>
    <?php else : ?>
        <div class="cc-container">
            <!-- Course form and other UI elements will go here -->
            <p>The user interface for creating and managing courses will be rendered here via JavaScript.</p>
        </div>
    <?php endif; ?>
</div>
