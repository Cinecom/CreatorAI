                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="cai-form-row">
                                        <div class="cai-form-field">
                                            <label for="cai_content_width">Content Width</label>
                                            <input type="text" id="cai_content_width" name="cai_course_appearance_settings[content_width]" 
                                                value="<?php echo esc_attr(isset($appearance_settings['content_width']) ? $appearance_settings['content_width'] : '1100px'); ?>"
                                                placeholder="e.g., 1100px or 90%">
                                        </div>
                                        <div class="cai-form-field">
                                            <label for="cai_sidebar_width">Sidebar Width (px)</label>
                                            <input type="number" id="cai_sidebar_width" name="cai_course_appearance_settings[sidebar_width]" 
                                                value="<?php echo esc_attr(isset($appearance_settings['sidebar_width']) ? $appearance_settings['sidebar_width'] : '280'); ?>"
                                                min="200" max="400">
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="cai-form-field">
                                        <label for="cai_certificate_background">Certificate Background</label>
                                        <div class="cai-media-field">
                                            <input type="text" id="cai_certificate_background" name="cai_course_appearance_settings[certificate_background]" 
                                                value="<?php echo esc_attr(isset($appearance_settings['certificate_background']) ? $appearance_settings['certificate_background'] : plugin_dir_url(dirname(__FILE__)) . 'assets/certificate-background.jpg'); ?>"
                                                class="regular-text">
                                            <button type="button" class="button cai-media-button" data-target="cai_certificate_background">Select Image</button>
                                        </div>
                                        <p class="description">Background image for certificates</p>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description">Control the width of the content area for course pages.</p>
                                </td>
                            </tr>
                        </table>
                    </div>
